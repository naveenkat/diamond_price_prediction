...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
          ...
          logging.info("exception occured as data transformation stage")
    ...
    def initiate_data_transformation(self,train_data_path,test_data_path):
        try:
            ...
            target_column = "price"
            drop_columns = [target_column,'Unnamed: 0']

            ## dividing the datasets in to independent and dependent features
            ...
            logging.info("applying preprocessing object on training and testing datasets completed.")
